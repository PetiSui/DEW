...
/**
 * Servlet implementation class GetInfoAlu
 */
@WebServlet("/GetInfoAlu")
public class GetInfoAlu extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String url = "http://dew-jortaga1-2021.dsic.cloud:9090/CentroEducativo/alumnos/" + alumno + "?key=" + key;
